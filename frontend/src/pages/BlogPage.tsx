...
export default function BlogPage() {
  ...
  return (
    <>
      {blog && (
        <section className="container px-2 mx-auto mt-10 sm:mt-16 md:mt-20">
          <div className="relative">
            ...
            <div className="mb-8 text-center">
              <p className="text-primary">
                Published on {formatDateStandard(blog.createdAt)}
              </p>
              <h1 className="max-w-2xl mx-auto my-4 text-3xl font-semibold leading-tight sm:text-4xl md:text-5xl">
                {blog.title}
              </h1>
          ...
          <div className="max-w-4xl px-5 mx-auto mt-6">
              ...
              >
                <div className="w-full">
                  <input
                    ...
                    className={`w-full p-3 transition border rounded-md outline-none focus:border-primary focus:ring-1 focus:ring-primary ${
                ...
                <div className="w-full">
                  <textarea
                    ...
                    className={`w-full p-3 transition border rounded-md outline-none focus:border-primary focus:ring-1 max-h-[400px] focus:ring-primary ${
            ...
            <div className="mt-12">
              ...
              <div className="flex items-center gap-x-4">
                <a
                  href="#"
                  className="block p-2 transition rounded-full shadow-md hover:shadow-sm"
                >
                  <img
